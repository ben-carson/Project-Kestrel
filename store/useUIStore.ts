...
/** Named constant you can import elsewhere */
...
export interface UIState {
  ...
  // Toast API
  toasts: Toast[];
  showToast: (message: string, type?: ToastType, opts?: { durationMs?: number }) => string;
...
export const useUIStore = create<UIState>((set, get) => ({
  ...
  // ---- Toasts ----
  showToast: (message, type = TOAST_TYPES.INFO, opts) => {
